...
public class Converts {
    ...
    public static void main(String[] args) {
        System.out.println(Integer.toBinaryString(-400));
        System.out.println(temperature((byte) 0x07, (byte) 0xFF));

        System.out.println(temperature((byte) 0x0E, (byte) 0x70));

        System.out.println(temperature((byte) 0x02, (byte) 0x27));
    }
