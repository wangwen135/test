...
public class CodecUtils {
    ...
    public static void main(String[] args) {
        String base64 = "U2FsdGVkX18t/XTaAEAbLRcrSIikQtHfTbiU+/Di93s=";
        byte[] bb = base64Decode(base64);
        System.out.println(hexEncode(bb));
