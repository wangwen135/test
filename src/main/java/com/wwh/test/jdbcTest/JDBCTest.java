...
public class JDBCTest {
     ...
     */
    public static final String URL = "jdbc:mysql://localhost:3306/appserver?useUnicode=true&characterEncoding=utf-8&autoReconnect=true";
    /**
     * 用户 密码
     */
